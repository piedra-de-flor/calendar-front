...
export default function MainPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // 사용자 정보 가져오기
                const userResponse = await axios.get('http://43.200.155.29/member', {
                    headers: {Authorization: `Bearer ${accessToken}`},
                });
                setUserInfo(userResponse.data);

                // 친구 목록 가져오기
                const friendsResponse = await axios.get('http://43.200.155.29/my-friends', {
                    headers: {Authorization: `Bearer ${accessToken}`},
                });
                setFriends(friendsResponse.data);

                // 팀 목록 가져오기
                const teamsResponse = await axios.get('http://43.200.155.29/my-teams', {
                    headers: {Authorization: `Bearer ${accessToken}`},
                });
                setTeams(teamsResponse.data);

                // 카테고리 데이터 가져오기
                const categoryResponse = await axios.get('http://43.200.155.29/schedule/category', {
                    headers: {Authorization: `Bearer ${accessToken}`},
                });
                ...
                // 월간 작업 데이터 가져오기
                const monthlyTasksResponse = await axios.get('http://43.200.155.29/schedule/task/month', {
                ...
                const kstTodayDate = new Date(today.getTime() + 9 * 60 * 60 * 1000)
                    .toISOString()
                    .split('T')[0];
                const todayTasksResponse = await axios.get('http://43.200.155.29/schedule/task/day', {
    ...
    const handleDeleteTask = async () => {
        try {
            ...
            const response = await axios.delete('http://43.200.155.29/schedule/task', {
    ...
    const handleEditSubmit = async () => {
        try {
            ...
            // 수정 요청 전송
            const response = await axios.patch('http://43.200.155.29/schedule/task', editTask, {
                headers: {Authorization: `Bearer ${accessToken}`},
            });

            // Task 카테고리 업데이트 요청
            if (editTask.taskId && editTask.categoryId) {
                await axios.patch('http://43.200.155.29/schedule/task/category', {
    ...
    const handleDeleteCategory = async (categoryId) => {
        try {
            ...
            await axios.delete('http://43.200.155.29/schedule/category', {
    ...
    const handleTaskSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                'http://43.200.155.29/schedule/task',
                {
        ...
        try {
            if (categoryEditMode) {
                ...
                const response = await axios.patch(
                    'http://43.200.155.29/schedule/category',
                    {
    ...
    const fetchFriends = async () => {
        try {
            ...
            const response = await axios.get("http://43.200.155.29/my-friends", {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
    ...
    const fetchFriendRequests = async () => {
        ...
        try {
            const sentResponse = await axios.get("http://43.200.155.29/invitations/send/friend", {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
            setSentFriendRequests(sentResponse.data);

            const receivedResponse = await axios.get("http://43.200.155.29/invitations/receive/friend", {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
    ...
    const handleAddFriend = async () => {
        ...
        try {
            const response = await axios.post(
                "http://43.200.155.29/invitation/friend",
...
// 버튼 클릭 핸들러 함수
    const handleAcceptRequest = async (request) => {
        try {
            ...
            const response = await axios.post(
                "http://43.200.155.29/invitation/accept",
    ...
    const handleRejectRequest = async (request) => {
        try {
            ...
            const response = await axios.post(
                "http://43.200.155.29/invitation/denied",
                null, // POST 요청의 body는 없으므로 null
                {
                    headers: {Authorization: `Bearer ${accessToken}`},
                    params: {invitationId: request.id}, // 쿼리 스트링으로 전달
    ...
    const handleCancelRequest = async (request) => {
        try {
            ...
            const response = await axios.delete("http://43.200.155.29/invitation", {
                headers: {Authorization: `Bearer ${accessToken}`},
    ...
    const handleConfirmDelete = async () => {
        try {
            ...
            const response = await axios.delete('http://43.200.155.29/friend', {
...
// 친구 오른쪽 클릭 핸들러
    ...
    const fetchTeams = async () => {
        try {
            ...
            const response = await axios.get("http://43.200.155.29/my-teams", {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
    ...
    const fetchTeamRequests = async () => {
        ...
        try {
            const sentResponse = await axios.get("http://43.200.155.29/invitations/send/team", {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
            setSentTeamRequests(sentResponse.data);

            const receivedResponse = await axios.get("http://43.200.155.29/invitations/receive/team", {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
    ...
    const handleViewTeamMembers = async (teamId) => {
        try {
            ...
            const response = await axios.get('http://43.200.155.29/team/friends', {
                params: { teamId },
                headers: { Authorization: `Bearer ${accessToken}` },
            });
    ...
    const handleConfirmLeaveTeam = async () => {
        ...
        try {
            ...
            const response = await axios.delete('http://43.200.155.29/team', {
    ...
    const handleAddFriendInTeam = async (teamId, friendEmail) => {
        try {
            ...
            const response = await axios.post('http://43.200.155.29/team/friend', {
                teamId,
                friendEmail,
            }, {
                headers: { Authorization: `Bearer ${accessToken}` },
    ...
    const handleCreateTeam = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://43.200.155.29/team',
                createDto,
                {headers: {Authorization: `Bearer ${accessToken}`}});
    ...
    async function fetchNotifications(page) {
        ...
        try {
            const response = await fetch(`http://43.200.155.29/notifications?page=${page}&size=10`, {
                headers: {Authorization: `Bearer ${accessToken}`},
            });
    ...
    useEffect(() => {
        ...
        const source = new EventSource(
            `http://43.200.155.29/notification/subscribe?token=${accessToken}`
        );
